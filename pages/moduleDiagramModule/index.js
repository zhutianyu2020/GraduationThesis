...
Page({
   ...
   */
  data: {
    showFontFamily:false,     //控制弹出层是否弹出的值
    showFontSize:false,
    showLineWidth:false,
    projectName: '',
    modules: [''],
  ...
  onFontFamilyChange(e) {
    this.setData({
      fontFamily: this.data.fontFamilies[e.detail.index],
      showFontFamily:false
    });
  },
  ...
  onFontSizeChange(e) {
    this.setData({
      fontSize: this.data.fontSizes[e.detail.index],
      showFontSize:false
    })
  },
  ...
  onLineWidthChange(e) {
    this.setData({
      lineWidth: this.data.lineWidths[e.detail.index],
      showLineWidth:false,
    })
  },
